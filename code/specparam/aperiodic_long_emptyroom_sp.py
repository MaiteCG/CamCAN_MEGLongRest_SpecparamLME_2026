# aperiodic_long_emptyroom_sp.py
"""
aperiodic_long_emptyroom_sp.py

Description: This script is used to fit the power spectral density (PSD) obtained from empty room recordings assigned to MEG longitudinal data with the FOOOF algorithm (as implemented in specparam package). The result of this fitting is the extraction of aperiodic parameters (exponent and offset) as well as periodic parameters (peaks in specific frequency bands).
