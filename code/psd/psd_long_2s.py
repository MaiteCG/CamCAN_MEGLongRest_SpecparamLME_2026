...
Description: This script is used to compute the power spectral density (PSD) for MEG longitudinal data, after being cleaned from IC artifacts. On 2 s epochs.
...
icselection = 'eog08' #'allbutecg04' # 'ecg04eog08' # 
